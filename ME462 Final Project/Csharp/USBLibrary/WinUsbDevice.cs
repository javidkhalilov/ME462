...
namespace USBLibrary
{
	...
	sealed public partial class WinUsbDevice
	{
		...
		public Boolean Do_Control_Read_Transfer(ref Byte[] dataStage)
		{
		...
		public Boolean Do_Control_Write_Transfer(Byte[] dataStage)
		{
			UInt32 bytesReturned = 0;
		...
		public Boolean QueryDeviceSpeed()
		{
			UInt32 length = 1;
		...
		///  <param name="success"> Success or failure status. </param>
		///  
		public void ReadViaInterruptTransfer
			(Byte pipeID,
			UInt32 bytesToRead,
			ref Byte[] buffer,
		...
		public Boolean SendViaInterruptTransfer(ref Byte[] buffer, UInt32 bytesToWrite)
		{
			UInt32 bytesWritten = 0;
			Boolean success;
        ...
        public Boolean FlushPipe(Byte pipeID)
        {
            WinUsb_FlushPipe(myDevInfo.winUsbHandle , pipeID);
